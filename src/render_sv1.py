...
m=trimesh.load_mesh(ROOT/'models/IBM_SVC_SV1_SingleNode.stl')
W,H=1600,1120
...
d.text((W/2,38),'IBM SVC SV1 - Single Node',font=ImageFont.truetype(bold,42),fill='#213343',anchor='mt')
