...
m=trimesh.load_mesh(ROOT/'models/IBM_SVC_SV1_Cluster.stl')
W,H=1600,1120
...
d.text((W/2,38),'IBM SVC SV1 - 2 Node Cluster',font=ImageFont.truetype(bold,42),fill='#213343',anchor='mt')
d.text((W/2,98),'STL render - not a photo | One manual colour change',font=ImageFont.truetype(font,24),fill='#536575',anchor='mt')
d.text((W/2,H-58),'163.4 x 92.4 x 57.2 mm | Black base / white chassis',font=ImageFont.truetype(font,23),fill='#536575',anchor='mt')
im.save(ROOT/'images/sv1_cluster.png')
