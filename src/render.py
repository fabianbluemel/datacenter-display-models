...
m=trimesh.load_mesh(ROOT/'models/Brocade_X6-8_100mm.stl')
W,H=1600,1120
...
d.text((W/2,38),'Brocade X6-8 | 100 mm Display',font=ImageFont.truetype(bold,42),fill='#213343',anchor='mt')
d.text((W/2,98),'STL render - not a photo | One manual colour change',font=ImageFont.truetype(font,24),fill='#536575',anchor='mt')
d.text((W/2,H-58),'163.4 x 92.4 x 100 mm | Black base / white chassis',font=ImageFont.truetype(font,23),fill='#536575',anchor='mt')
im.save(ROOT/'images/preview.png')
