...
m=trimesh.load_mesh(ROOT/'models/Dell_Compellent_SC8000.stl')
W,H=1600,1120
...
d.text((W/2,38),'Dell Compellent SC8000',font=ImageFont.truetype(bold,42),fill='#213343',anchor='mt')
...
im.save(ROOT/'images/sc8000.png')
